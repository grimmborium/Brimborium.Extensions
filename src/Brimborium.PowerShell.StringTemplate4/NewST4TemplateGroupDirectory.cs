...
namespace Brimborium.PowerShell.StringTemplate4 {
    [Cmdlet(VerbsCommon.New, "ST4TemplateGroupDirectory")]
    [OutputType(typeof(ST4TemplateGroup))]
    public class NewST4TemplateGroupDirectory : PSCmdlet {
        [Parameter(
            Mandatory = true,
            Position = 0,
        ...
        protected override void ProcessRecord() {
            var templateGroup = new TemplateGroupDirectory(this.DirectoryPath);
