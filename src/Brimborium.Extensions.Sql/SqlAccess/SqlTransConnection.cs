...
namespace Brimborium.Extensions.SqlAccess {
    ...
    /// <summary>SqlConnection and SqlTransaction.</summary>
    public sealed class SqlTransConnection : IDisposable {
        private string _ConnectionString;
        private SqlConnection _Connection;
        private SqlTransaction _Transaction;

        /// <summary>Initializes a new instance of the <see cref="SqlTransConnection"/> class.</summary>
        ...
        public SqlTransConnection(IUnifiedConnectionString connectionString) {
            ...
            //
            this._Connection = new SqlConnection(connectionString.GetAsSqlConnectionString());
        }
        ~SqlTransConnection() {
            this.Dispose(false);
        }
